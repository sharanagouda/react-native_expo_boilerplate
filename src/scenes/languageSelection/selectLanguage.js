...
function selectLanguageFn(selectedItem, selectedLanguages, setSelectedLanguage) => {
...
const renderCard = ({ item, isSelected, selectedLanguages,  setSelectedLanguage}) => {
  ...
  return (
    <Card
      ...
      textFont={font}
      item={item}
      didSelect={(value) => selectLanguageFn(value, selectedLanguages, setSelectedLanguage)}
    />
  );
};
...
const renderProceedButton = (navigation) => (
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.flatListView}>
        <FlatList
          // scrollEnabled={false}
          data={languageData, isSelected, selectedLanguages, setSelectedLanguage}
          renderItem={renderCard}
          numColumns={2}
          keyExtractor={(item, index) => index.toString()}
        />
      </View>
      {selectedLanguages.length > 0 ? renderProceedButton(navigation) : null}
      {/* </ScrollView> */}
      <Button
